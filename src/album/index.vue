   ...
   <div style="margin-top: 5%">
     ...
     <table><thead>
      <tr><th>Nombre</th><th>Genero</th><th>Fecha publicacion</th>
          <th>Duracion</th><th>Discografica</th><th>Artista</th><th>Descripcion</th></tr>
      </thead><tbody>
      ...
      <router-link class="button"
        :to="'/album/show/'+album.id">Show</router-link>
      <router-link class="button"
        :to="'/album/edit/'+album.id">Edit</router-link>
      <a class="button"
        v-on:click="deleteAlbum(album.id)">Delete</a>
      </td>
      </tr></tbody>
     </table>
     <router-link class="button button-primary" 
       to="/album/create">New</router-link>
   </div>
  </div>
</template>
<script>
